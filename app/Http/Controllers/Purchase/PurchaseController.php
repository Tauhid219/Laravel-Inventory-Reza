...
class PurchaseController extends Controller
{
    ...
    {
        $this->middleware('permission:view purchase')->only(['index', 'show', 'approvedPurchases', 'pendingPurchases', 'dailyPurchaseReport', 'getPurchaseReport', 'exportPurchaseReport', 'exportExcel']);
    ...
    {
        $purchase->with(['supplier', 'details', 'createdBy', 'updatedBy'])->get();
