                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-control form-control-solid">
                                    {{ $purchase->createdBy ? $purchase->createdBy->name : '-' }}</div>
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1">Updated By</label>
                                <div class="form-control form-control-solid">
                                    {{ $purchase->updatedBy ? $purchase->updatedBy->name : '-' }}</div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td scope="row"><span
                                                        class="btn btn-warning">{{ $product->product->stock }}</span></td>
                                                <td scope="row"><span
                                                        class="btn btn-success">{{ $product->quantity }}</span></td>
