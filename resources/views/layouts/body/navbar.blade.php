        ...
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown {{ request()->is('orders-v2*') ? 'active' : null }}">
                        <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                            data-bs-auto-close="outside" role="button" aria-expanded="false">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href="{{ route('ordersV2.index') }}">
                                        {{ __('All') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ route('ordersV2.completedOrders') }}">
                                        {{ __('Completed') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ route('ordersV2.pendingOrders') }}">
                                        {{ __('Pending') }}
                                    </a>
                                    {{-- <a class="dropdown-item" href="{{ route('purchases.dailyPurchaseReport') }}">
                                        {{ __('Daily Purchase Report') }}
