...
@section('content')
    <x-adminlte.page-header :title="__('Pending Orders')" subtitle="Review sales orders that are still waiting to be completed.">
        <x-slot:actions>
            <div class="btn-group">
    ...
    <x-adminlte.page-body container-class="container container-xl">
        ...
        @if ($orders->isEmpty())
            <x-empty title="No orders found"
                message="Create an order to start tracking pending invoices and customer sales."
