...
@section('content')
    <x-adminlte.page-header :title="__('Completed Orders')" subtitle="Browse completed invoices and access printable order records.">
        <x-slot:actions>
            <div class="btn-group">
    ...
    <x-adminlte.page-body container-class="container container-xl">
        ...
        @if ($orders->isEmpty())
            <x-empty title="No orders found"
                message="Completed orders will appear here after pending invoices are finalized."
