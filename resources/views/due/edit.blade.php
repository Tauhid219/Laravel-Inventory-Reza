...
@section('content')
    <x-adminlte.page-header :title="__('Edit Due Order')" subtitle="Review the invoice context before recording an additional payment.">
        <x-slot:breadcrumbs>
    ...
    <x-adminlte.page-body>
        ...
        <x-card>
            <x-slot:header>
                ...
                <x-slot:actions>
                    <a href="{{ route('due.show', $order) }}" class="btn btn-default">
                        {{ __('View Order') }}
                    </a>
